...
- 孫茂棋：
- 林昶任：
- 吳承諺：我覺得資料庫系統在資工的領域是很重要的一環，在現實生活中也可以找到實際的應用範圍，例如簡單的點餐系統，物流的倉庫系統，甚至餐廳等等背後都有一套資料庫系統支撐著，上了這門課之後，我不僅學習到架設資料庫的方法，也從江季翰老師那裡學到很多實用技術與應用，很可惜只有短短的一學期可以學習，背後還有很多技術和理論等者我去學習，如果有機會我還想繼續學更多有關資料庫的使用方法和語法。
