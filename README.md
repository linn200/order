...
<table border="1">
  ...
  <tr>
    ...
    <td>四資工三乙</td>
    <td>簡報製作、資料查詢</td>
    <td>這次製作飲料點餐系統的專題，讓我從零開始學習資料庫的設計與應用，包括資料表建立、欄位設計、資料關聯以及 SQL 查詢與統計功能的實作。在整個開發過程中，我更了解如何將實際的點餐流程轉換為有系統的資料結構，也學會了如何使用 ER 圖規劃資料關聯，並設計出符合需求的資料庫架構。這些經驗不僅加深了我對資料庫操作的理解，也讓我體會到資料管理在資訊系統中的重要角色，對我未來開發系統會有很大的幫助。</td>
  </tr>
  <tr>
    <td>孫茂棋</td>
    <td>41143227</td>
